...
set :repository,  "git@github.com:Unayung/redmine_for_damedia.git"
set :scm, :git
set :user, "apps"
set :runner, "apps"
...
namespace :my_tasks do
  task :symlink, :roles => [:web] do
    ...
    ## redmine needs generate_secret_token
    run %Q{cd #{latest_release} && rake RAILS_ENV=#{rails_env} generate_secret_token}
  end
